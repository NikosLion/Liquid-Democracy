    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < activeInitiatives.size(); i++) {
                ...
                out.println("<button id='upvote' type='button' onclick='VoteUpdateVote(\"vote\",\"upvote\",\"" + activeInitiatives.get(i).getTitle() + "\",\"" + activeInitiatives.get(i).getCreator() + "\",\"" + request.getParameter("username") + "\")'>upvote</button>");
                out.println("<button id='downvote' type='button' onclick='VoteUpdateVote(\"vote\",\"downvote\",\"" + activeInitiatives.get(i).getTitle() + "\",\"" + activeInitiatives.get(i).getCreator() + "\",\"" + request.getParameter("username") + "\")'>downvote</button>");
            }
            out.println("</body>");
            out.println("</html>");
